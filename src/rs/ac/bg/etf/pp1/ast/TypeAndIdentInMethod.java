...
public class TypeAndIdentInMethod implements SyntaxNode {
    ...
    public TypeAndIdentInMethod (TypeOrVoid TypeOrVoid, String methName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("TypeAndIdentInMethod(\n");
