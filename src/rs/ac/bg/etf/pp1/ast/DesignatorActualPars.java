...
public class DesignatorActualPars extends DesignatorStatement {

    private Designator Designator;
    private ActualPars ActualPars;

    public DesignatorActualPars (Designator Designator, ActualPars ActualPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorActualPars(\n");
