...
public class ForStatementInitializationAndCondition extends Statement {
    ...
    public ForStatementInitializationAndCondition (For For, ForInitialization ForInitialization, ForCondition ForCondition, Statement Statement) {
        this.For=For;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ForStatementInitializationAndCondition(\n");
