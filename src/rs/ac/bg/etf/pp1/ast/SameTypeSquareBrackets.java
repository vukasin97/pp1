...
public class SameTypeSquareBrackets extends Sametype {

    private String varName;
    private Sametype Sametype;

    public SameTypeSquareBrackets (String varName, Sametype Sametype) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SameTypeSquareBrackets(\n");
