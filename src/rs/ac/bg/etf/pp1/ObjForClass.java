...
public class ObjForClass extends Obj {
	...
	public ObjForClass(int kind, String name, Struct type, int adr, int level) {
		super(kind, name, type, adr, level);
		// TODO Auto-generated constructor stub
	}

	public ObjForClass(int kind, String name, Struct type) {
